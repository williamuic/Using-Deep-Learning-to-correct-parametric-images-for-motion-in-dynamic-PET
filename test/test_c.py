...
if __name__ == '__main__':
    ...
    if not os.path.exists('test_results_c'):
        os.makedirs('test_results_c')
    ...
    for i, data in enumerate(dataset):
        ...
        np.save(f'test_results_c/real_A_{i}.npy', real_A_denorm.cpu().numpy())
        np.save(f'test_results_c/fake_B_{i}.npy', output_denorm.detach().cpu().numpy())
        np.save(f'test_results_c/real_B_{i}.npy', real_B_denorm.cpu().numpy())
