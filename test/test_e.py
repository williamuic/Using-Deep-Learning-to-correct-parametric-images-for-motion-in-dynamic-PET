...
if __name__ == '__main__':
    ...
    if not os.path.exists('test_results_e'):
        os.makedirs('test_results_e')
    ...
    for i, data in enumerate(dataset):
        ...
        np.save(f'test_results_e/real_A_{i}.npy', real_A_denorm.cpu().numpy())
        np.save(f'test_results_e/fake_B_{i}.npy', fake_B_denorm.cpu().numpy())
        np.save(f'test_results_e/real_B_{i}.npy', real_B_denorm.cpu().numpy())
